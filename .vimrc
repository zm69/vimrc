...
" this solves the problem that pressing down jumpes your cursor 
" “over” the current line to the next line. 
" It changes behaviour so that it jumps to the next 
" row in the editor (much more natural)
